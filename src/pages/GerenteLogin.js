...
export default function GerenteLogin() {
  ...
  // Estilos idénticos al Admin (consistencia visual)
  const estilos = {
    fondo: {
      minHeight: "100vh",
    ...
    <div style={estilos.fondo}>
      <div style={estilos.caja}>
        <div style={estilos.header}>
          ...
          <h2 style={estilos.titulo}>🔐 Ingreso Gerente</h2>
        </div>

        {error && <div role="alert" style={estilos.error}>{error}</div>}

        <form style={estilos.form} onSubmit={handleLogin} noValidate>
          <label htmlFor="gerente-usuario" style={estilos.labelOculto}>Usuario</label>
          <input
            id="gerente-usuario"
            type="text"
            placeholder="Usuario"
          ...
          <label htmlFor="gerente-clave" style={estilos.labelOculto}>Contraseña</label>
          <input
            id="gerente-clave"
